        ...
        <main>
            ...
            <article className="journal-entry">
                ...
                <div className="info-container">
                    ...
                    <p className="trip-dates">27 May, 2023 - 8 Jun, 2023</p>
            ...
            <article className="journal-entry">
                ...
                <div className="info-container">
                    ...
                    <p className="trip-dates">01 Oct, 2024 - 18 Nov, 2024</p>
                    <p className="entry-text">The Geiranger Fjord is a fjord in the Sunnmøre region of Møre og Romsdal county, Norway. It is located entirely in the Stranda Municipality.</p>
                </div>
            </article>
        </main>
    )
